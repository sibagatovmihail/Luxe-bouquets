    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                } else if (e.target.closest("[data-popup]")) document.documentElement.classList.remove("menu-open");
            }));
            if (document.querySelector(".cart-header__button")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".cart-header__button")) {
                    bodyLockToggle();
        ...
        if (document.querySelector("[data-datepicker]")) {
            const picker = datepicker_min("[data-datepicker]", {
                customDays: [ "Sn", "Mo", "Tu", "We", "Th", "Fr", "Sa" ],
        ...
        function initSliders() {
            ...
            if (document.querySelector(".accessories__slider")) new swiper_core_Swiper(".accessories__slider", {
                modules: [ Navigation ],
                slidesPerView: 5,
                spaceBetween: 20,
                autoHeight: true,
            ...
            function pageNavigationAction(e) {
                if (e.type === "click") {
                    ...
                    if (targetElement.closest("[data-goto]")) {
                        ...
                        const gotoPage = gotoLink.dataset.gotoPage ? gotoLink.dataset.gotoPage : null;
                        ...
                        } else gotoblock_gotoBlock(gotoLinkSelector, gotoPage, noHeader, gotoSpeed, offsetTop);
                        e.preventDefault();
                    }
        ...
        const cartClose = document.querySelector(".heading-cart__close");
        document.querySelector("body");
        const loc = window.location;
        if (cartClose) cartClose.addEventListener("click", (() => {
            documentElement.classList.remove("cart-open");
            bodyLockToggle(0);
        }));
        let elemHeight = 0;
        const header = document.querySelector("header.header");
        document.querySelector(".header__sign-in").addEventListener("click", (() => {
        ...
        function elementHeight() {
            ...
            documentElement.style.setProperty("--header-height", `${elemHeight}px`);
        }
        window["FLS"] = true;
        isWebp();
        menuInit();
